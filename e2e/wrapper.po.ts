...
import {
  ...
  DP_WEEKS_ARROW_UP, DP_DAYS_ARROW_UP, DP_HOURS_ARROW_UP, DP_MINUTES_ARROW_UP, DP_SECONDS_ARROW_UP, DP_YEARS_ARROW_DOWN, DP_MONTHS_ARROW_DOWN,
  DP_WEEKS_ARROW_DOWN, DP_DAYS_ARROW_DOWN, DP_HOURS_ARROW_DOWN, DP_MINUTES_ARROW_DOWN, DP_SECONDS_ARROW_DOWN, DP_YEARS_INPUT, DP_MONTHS_INPUT,
  DP_WEEKS_INPUT, DP_DAYS_INPUT, DP_HOURS_INPUT, DP_MINUTES_INPUT, DP_SECONDS_INPUT, DP_VALUE, DP_SIGN
} from './constants';
